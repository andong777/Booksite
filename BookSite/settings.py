...
DATABASES = {
    'default': {
        ...
        'USER': 'user201100300002',
        'PASSWORD': '123',
        'HOST': '211.87.224.23',                      # Empty for localhost through domain sockets or '127.0.0.1' for localhost through TCP.
...
STATIC_ROOT = 'D:/BookSite/templates/'
FILE_PATH = 'D:/BookSite/templates/'
...
SECRET_KEY = 'g2*d%=f97joaw#!6_dpybx_5qj^ghzizk2o36-roc%uvx)z0&_'
